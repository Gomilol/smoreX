...
// drawing created by https://guidedhacking.com/members/kix.87156/
...
void GL::Font::Print(float x, float y, ImVec4 color, const char* format, ...) {
	...
	if (fontHDC != f.hdc) {
		base = glGenLists(96);
		HFONT hFont = CreateFontA(-cfg::fHeight, 0, 0, 0, FW_MEDIUM, FALSE, FALSE, FALSE, ANSI_CHARSET, OUT_TT_PRECIS, CLIP_DEFAULT_PRECIS, PROOF_QUALITY, FF_DONTCARE | DEFAULT_PITCH, "Arial");
